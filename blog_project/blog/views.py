...
class BlogInTopicSerializer(drf_serializers.ModelSerializer):
...
class TopicDetailView(APIView):
    ...
    def delete(self, request, pk):
        ...
        try:
            topic.delete()
            return success_response(message="Topic deleted.",
...
class BlogDetailByIdView(APIView):
    ...
    def get(self, request, pk):
        ...
        if not blog.is_published:
            if not request.user.is_authenticated:
                return error_response("This blog is not published yet.",
    ...
    def patch(self, request, pk):
        ...
        blog = self.get_object(pk)
        if request.user != blog.author and not request.user.is_admin_user():
            return error_response("You can only edit your own blogs.",
                                   status_code=status.HTTP_403_FORBIDDEN)
    ...
    def delete(self, request, pk):
        ...
        blog = self.get_object(pk)
        if request.user != blog.author and not request.user.is_admin_user():
            return error_response("You can only delete your own blogs.",
                                   status_code=status.HTTP_403_FORBIDDEN)
        blog.delete()
...
class BlogDetailBySlugView(APIView):
    ...
    def get(self, request, slug):
        ...
        if not blog.is_published:
            if not request.user.is_authenticated:
                return error_response("This blog is not published.",
                                       status_code=status.HTTP_403_FORBIDDEN)
            if request.user != blog.author and not request.user.is_admin_user():
                return error_response("This blog is not published.",
                                       status_code=status.HTTP_403_FORBIDDEN)
...
class BlogPublishToggleView(APIView):
    ...
    def patch(self, request, pk):
        ...
        if request.user != blog.author and not request.user.is_admin_user():
            return error_response("You can only publish your own blogs.",
                                   status_code=status.HTTP_403_FORBIDDEN)
...
class CommentDetailView(APIView):
    ...
    def patch(self, request, blog_id, comment_id):
        ...
        if comment.user != request.user:
            return error_response("You can only edit your own comments.",
                                   status_code=status.HTTP_403_FORBIDDEN)
        serializer = CommentUpdateSerializer(comment, data=request.data, partial=True)
        if not serializer.is_valid():
            return error_response("Update failed.", serializer.errors)
        serializer.save()
        return success_response(data=CommentSerializer(comment).data,
    ...
    def delete(self, request, blog_id, comment_id):
        ...
        if not can_delete:
            return error_response("You cannot delete this comment.",
                                   status_code=status.HTTP_403_FORBIDDEN)
        comment.soft_delete()
